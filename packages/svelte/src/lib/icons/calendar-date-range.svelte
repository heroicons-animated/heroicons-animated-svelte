...
>
  <svg
    ...
    class="icon-svg"
    class:calendardaterange-animate={isAnimating}
  >
    <path
...
.icon-svg.calendardaterange-animate {
  animation: calendardaterange-animate 0.6s ease-in-out;
}

@keyframes calendardaterange-animate {
  0% {
    transform: scale(1);
  }
  50% {
