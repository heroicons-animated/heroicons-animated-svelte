...
>
  <svg
    ...
    class="icon-svg"
    class:bellsnooze-animate={isAnimating}
  >
    <g>
      <path
    ...
    <path d="M10.5 8.25H13.5L10.5 12.75H13.5"/>
  </svg>
</div>
...
.icon-svg.bellsnooze-animate {
  animation: bellsnooze-animate 0.6s ease-in-out;
}

@keyframes bellsnooze-animate {
  0% {
    transform: scale(1);
  }
  50% {
