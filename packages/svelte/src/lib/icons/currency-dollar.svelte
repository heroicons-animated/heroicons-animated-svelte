...
>
  <svg
    ...
    class="icon-svg"
    class:currencydollar-animate={isAnimating}
  >
    <path
...
.icon-svg.currencydollar-animate {
  animation: currencydollar-animate 0.6s ease-in-out;
}

@keyframes currencydollar-animate {
  0% {
    transform: scale(1);
  }
  50% {
