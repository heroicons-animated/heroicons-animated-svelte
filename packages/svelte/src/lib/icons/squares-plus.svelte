...
>
  <svg
    ...
    class="icon-svg"
    class:squaresplus-animate={isAnimating}
  >
    <path
    ...
    />
    <path d="M16.875 13.5v6.75"/>
    <path d="M13.5 16.875h6.75"/>
  </svg>
</div>
...
.icon-svg.squaresplus-animate {
  animation: squaresplus-animate 0.6s ease-in-out;
}

@keyframes squaresplus-animate {
  0% {
    transform: scale(1);
  }
  50% {
