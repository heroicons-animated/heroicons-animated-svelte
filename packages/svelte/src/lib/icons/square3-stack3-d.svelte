...
>
  <svg
    ...
    class="icon-svg"
    class:square3stack3d-animate={isAnimating}
  >
...
<style>
  ...
  .icon-svg.square3stack3d-animate {
    animation: square3stack3d-animate 0.6s ease-in-out;
  }

  @keyframes square3stack3d-animate {
    0% {
      transform: scale(1);
    }
    50% {
