...
>
  <svg
    ...
    class="icon-svg"
    class:archiveboxxmark-animate={isAnimating}
  >
    <path
    ...
    <path d="M9.75 11.625L14.25 16.125"/>
    <path d="M14.25 11.625L9.75 16.125"/>
    <path
...
.icon-svg.archiveboxxmark-animate {
  animation: archiveboxxmark-animate 0.6s ease-in-out;
}

@keyframes archiveboxxmark-animate {
  0% {
    transform: scale(1);
  }
  50% {
