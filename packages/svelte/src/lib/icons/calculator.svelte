...
>
  <svg
    ...
    class="icon-svg"
    class:calculator-animate={isAnimating}
  >
    <path
    ...
    <path d="M8.25 11.25H8.2575V11.2575H8.25V11.25Z" />
    <path d="M10.7476 11.25H10.7551V11.2575H10.7476V11.25Z" />
    <path d="M13.2524 13.5H13.2599V13.5075H13.2524V13.5Z" />
    <path d="M8.25 15.75H8.2575V15.7575H8.25V15.75Z" />
    <path d="M15.75 11.25H15.7575V11.2575H15.75V11.25Z" />
    <path d="M10.7476 18H10.7551V18.0075H10.7476V18Z" />
...
.icon-svg.calculator-animate {
  animation: calculator-animate 0.6s ease-in-out;
}

@keyframes calculator-animate {
  0% {
    transform: scale(1);
  }
  50% {
