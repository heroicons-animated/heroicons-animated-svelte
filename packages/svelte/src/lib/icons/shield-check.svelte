...
>
  <svg
    ...
    class="icon-svg"
    class:shieldcheck-animate={isAnimating}
  >
    <path
    ...
    />
    <path d="M9 12.7498L11.25 14.9998L15 9.74985"/>
  </svg>
</div>
...
.icon-svg.shieldcheck-animate {
  animation: shieldcheck-animate 0.6s ease-in-out;
}

@keyframes shieldcheck-animate {
  0% {
    transform: scale(1);
  }
  50% {
