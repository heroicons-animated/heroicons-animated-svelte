...
>
  <svg
    ...
    class="icon-svg"
    class:clipboarddocumentcheck-animate={isAnimating}
  >
    <path
...
.icon-svg.clipboarddocumentcheck-animate {
  animation: clipboarddocumentcheck-animate 0.6s ease-in-out;
}

@keyframes clipboarddocumentcheck-animate {
  0% {
    transform: scale(1);
  }
  50% {
