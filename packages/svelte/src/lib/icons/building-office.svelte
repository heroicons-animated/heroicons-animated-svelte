...
>
  <svg
    ...
    class="icon-svg"
    class:buildingoffice-animate={isAnimating}
  >
...
<style>
  ...
  .icon-svg.buildingoffice-animate {
    animation: buildingoffice-animate 0.6s ease-in-out;
  }

  @keyframes buildingoffice-animate {
    0% {
      transform: scale(1);
    }
    50% {
