...
>
  <svg
    ...
    class="icon-svg"
    class:questionmarkcircle-animate={isAnimating}
  >
    <path
...
.icon-svg.questionmarkcircle-animate {
  animation: questionmarkcircle-animate 0.6s ease-in-out;
}

@keyframes questionmarkcircle-animate {
  0% {
    transform: scale(1);
  }
  50% {
