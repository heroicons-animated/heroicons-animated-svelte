...
>
  <svg
    ...
    class="icon-svg"
    class:videocamera-animate={isAnimating}
  >
    <path
    ...
    />
    <circle cx="5" cy="7.5" fill="red" r="1" stroke="none" />
  </svg>
</div>
...
.icon-svg.videocamera-animate {
  animation: videocamera-animate 0.6s ease-in-out;
}

@keyframes videocamera-animate {
  0% {
    transform: scale(1);
  }
  50% {
