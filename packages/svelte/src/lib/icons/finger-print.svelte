...
>
  <svg
    ...
    class="icon-svg"
    class:fingerprint-animate={isAnimating}
  >
    <path
    ...
    <path
      ...
      stroke-opacity={0.4}
    />
    <path d="M15.033 15.6543C14.4852 17.5743 13.6391 19.3685 12.5479 20.9836"/>
  </svg>
</div>
...
.icon-svg.fingerprint-animate {
  animation: fingerprint-animate 0.6s ease-in-out;
}
