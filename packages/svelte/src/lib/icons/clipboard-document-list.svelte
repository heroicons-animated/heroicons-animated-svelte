...
>
  <svg
    ...
    class="icon-svg"
    class:clipboarddocumentlist-animate={isAnimating}
  >
    <path
...
.icon-svg.clipboarddocumentlist-animate {
  animation: clipboarddocumentlist-animate 0.6s ease-in-out;
}

@keyframes clipboarddocumentlist-animate {
  0% {
    transform: scale(1);
  }
  50% {
