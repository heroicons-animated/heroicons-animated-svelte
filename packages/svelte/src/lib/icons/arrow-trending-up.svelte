...
>
  <svg
    ...
    class="icon-svg"
    class:arrowtrendingup-animate={isAnimating}
  >
    <path
...
<style>
  ...
  .icon-svg.arrowtrendingup-animate {
    animation: arrowtrendingup-animate 0.6s ease-in-out;
  }

  @keyframes arrowtrendingup-animate {
    0% {
      transform: scale(1);
    }
    50% {
