...
>
  <svg
    ...
    class="icon-svg"
    class:documentarrowdown-animate={isAnimating}
  >
    <path
    ...
    />
    <path d="M9 14.25L12 17.25M12 17.25L15 14.25M12 17.25L12 11.25" />
  </svg>
</div>
...
.icon-svg.documentarrowdown-animate {
  animation: documentarrowdown-animate 0.6s ease-in-out;
}

@keyframes documentarrowdown-animate {
  0% {
    transform: scale(1);
  }
  50% {
