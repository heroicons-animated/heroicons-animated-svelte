...
>
  <svg
    ...
    class="icon-svg"
    class:documentarrowup-animate={isAnimating}
  >
    <path
    ...
    />
    <path d="M15 14.25L12 11.25M12 11.25L9 14.25M12 11.25L12 17.25" />
  </svg>
</div>
...
.icon-svg.documentarrowup-animate {
  animation: documentarrowup-animate 0.6s ease-in-out;
}

@keyframes documentarrowup-animate {
  0% {
    transform: scale(1);
  }
  50% {
