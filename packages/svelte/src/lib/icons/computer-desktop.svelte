...
>
  <svg
    ...
    class="icon-svg"
    class:computerdesktop-animate={isAnimating}
  >
    <path
...
<style>
  ...
  .icon-svg.computerdesktop-animate {
    animation: computerdesktop-animate 0.6s ease-in-out;
  }

  @keyframes computerdesktop-animate {
    0% {
      transform: scale(1);
    }
    50% {
