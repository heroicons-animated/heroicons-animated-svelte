...
>
  <svg
    ...
    class="icon-svg"
    class:shieldexclamation-animate={isAnimating}
  >
    <path
...
.icon-svg.shieldexclamation-animate {
  animation: shieldexclamation-animate 0.6s ease-in-out;
}

@keyframes shieldexclamation-animate {
  0% {
    transform: scale(1);
  }
  50% {
