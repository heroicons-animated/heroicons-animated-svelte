...
>
  <svg
    ...
    class="icon-svg"
    class:divide-animate={isAnimating}
  >
    <path d="M4.49902 11.9983H19.4987" />
    <g>
...
.icon-svg.divide-animate {
  animation: divide-animate 0.6s ease-in-out;
}

@keyframes divide-animate {
  0% {
    transform: scale(1);
  }
  50% {
