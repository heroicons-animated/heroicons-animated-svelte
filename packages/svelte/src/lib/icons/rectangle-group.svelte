...
>
  <svg
    ...
    class="icon-svg"
    class:rectanglegroup-animate={isAnimating}
  >
    <path
...
.icon-svg.rectanglegroup-animate {
  animation: rectanglegroup-animate 0.6s ease-in-out;
}

@keyframes rectanglegroup-animate {
  0% {
    transform: scale(1);
  }
  50% {
