...
>
  <svg
    ...
    class="icon-svg"
    class:videocameraslash-animate={isAnimating}
  >
...
<style>
  ...
  .icon-svg.videocameraslash-animate {
    animation: videocameraslash-animate 0.6s ease-in-out;
  }

  @keyframes videocameraslash-animate {
    0% {
      transform: scale(1);
    }
    50% {
