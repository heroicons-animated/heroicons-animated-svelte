...
>
  <svg
    ...
    class="icon-svg"
    class:documentmagnifyingglass-animate={isAnimating}
  >
    <path
...
.icon-svg.documentmagnifyingglass-animate {
  animation: documentmagnifyingglass-animate 0.6s ease-in-out;
}

@keyframes documentmagnifyingglass-animate {
  0% {
    transform: scale(1);
  }
  50% {
