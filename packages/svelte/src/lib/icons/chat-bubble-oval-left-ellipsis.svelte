...
>
  <svg
    ...
    class="icon-svg"
    class:chatbubbleovalleftellipsis-animate={isAnimating}
  >
...
.icon-svg.chatbubbleovalleftellipsis-animate {
  animation: chatbubbleovalleftellipsis-animate 0.6s ease-in-out;
}

@keyframes chatbubbleovalleftellipsis-animate {
  0% {
    transform: scale(1);
  }
  50% {
