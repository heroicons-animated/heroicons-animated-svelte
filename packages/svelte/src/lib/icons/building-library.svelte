...
>
  <svg
    ...
    class="icon-svg"
    class:buildinglibrary-animate={isAnimating}
  >
    <path
...
.icon-svg.buildinglibrary-animate {
  animation: buildinglibrary-animate 0.6s ease-in-out;
}

@keyframes buildinglibrary-animate {
  0% {
    transform: scale(1);
  }
  50% {
