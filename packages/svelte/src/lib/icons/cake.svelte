...
>
  <svg
    ...
    class="icon-svg"
    class:cake-animate={isAnimating}
  >
    <path
    ...
    <path d="M9.265 3.11a.375.375 0 1 1-.53 0L9 2.845l.265.265Z" />
    <path d="M12.265 3.11a.375.375 0 1 1-.53 0L12 2.845l.265.265Z" />
    <path d="M15.265 3.11a.375.375 0 1 1-.53 0L15 2.845l.265.265Z" />
  </svg>
</div>
...
.icon-svg.cake-animate {
  animation: cake-animate 0.6s ease-in-out;
}

@keyframes cake-animate {
  0% {
    transform: scale(1);
  }
  50% {
