...
>
  <svg
    ...
    class="icon-svg"
    class:globeasiaaustralia-animate={isAnimating}
  >
    <path
    ...
    />
    <path d="M15.75 9c0 .896-.393 1.7-1.016 2.25" />
  </svg>
</div>
...
.icon-svg.globeasiaaustralia-animate {
  animation: globeasiaaustralia-animate 0.6s ease-in-out;
}

@keyframes globeasiaaustralia-animate {
  0% {
    transform: scale(1);
  }
  50% {
