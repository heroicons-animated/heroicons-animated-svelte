...
>
  <svg
    ...
    class="icon-svg"
    class:rectanglestack-animate={isAnimating}
  >
...
<style>
  ...
  .icon-svg.rectanglestack-animate {
    animation: rectanglestack-animate 0.6s ease-in-out;
  }

  @keyframes rectanglestack-animate {
    0% {
      transform: scale(1);
    }
    50% {
