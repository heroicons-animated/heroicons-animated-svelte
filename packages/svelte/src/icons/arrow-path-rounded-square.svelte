...
>
  <svg
    ...
    class="icon-svg"
    class:arrowpathroundedsquare-animate={isAnimating}
  >
...
<style>
  ...
  .icon-svg.arrowpathroundedsquare-animate {
    animation: arrowpathroundedsquare-animate 0.6s ease-in-out;
  }

  @keyframes arrowpathroundedsquare-animate {
    0% {
      transform: scale(1);
    }
    50% {
