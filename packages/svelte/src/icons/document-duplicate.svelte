...
>
  <svg
    ...
    class="icon-svg"
    class:documentduplicate-animate={isAnimating}
  >
    <path
...
<style>
  ...
  .icon-svg.documentduplicate-animate {
    animation: documentduplicate-animate 0.6s ease-in-out;
  }

  @keyframes documentduplicate-animate {
    0% {
      transform: scale(1);
    }
    50% {
