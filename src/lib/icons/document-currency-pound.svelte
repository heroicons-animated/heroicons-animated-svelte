...
>
  <svg
    ...
    class="icon-svg"
    class:documentcurrencypound-animate={shouldAnimate}
  >
    <path
...
<style>
  ...
  .icon-svg.documentcurrencypound-animate {
    animation: documentcurrencypound-animate 0.6s ease-in-out;
  }

  @keyframes documentcurrencypound-animate {
    0% {
      transform: scale(1);
    }
    50% {
