...
>
  <svg
    ...
    class="icon-svg"
    class:documentcurrencydollar-animate={shouldAnimate}
  >
    <path
...
<style>
  ...
  .icon-svg.documentcurrencydollar-animate {
    animation: documentcurrencydollar-animate 0.6s ease-in-out;
  }

  @keyframes documentcurrencydollar-animate {
    0% {
      transform: scale(1);
    }
    50% {
