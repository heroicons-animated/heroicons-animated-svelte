...
>
  <svg
    ...
    class="icon-svg"
    class:documentcurrencyyen-animate={shouldAnimate}
  >
    <path
...
<style>
  ...
  .icon-svg.documentcurrencyyen-animate {
    animation: documentcurrencyyen-animate 0.6s ease-in-out;
  }

  @keyframes documentcurrencyyen-animate {
    0% {
      transform: scale(1);
    }
    50% {
