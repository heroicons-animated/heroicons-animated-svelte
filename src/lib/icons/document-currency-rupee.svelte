...
>
  <svg
    ...
    class="icon-svg"
    class:documentcurrencyrupee-animate={shouldAnimate}
  >
    <path
...
<style>
  ...
  .icon-svg.documentcurrencyrupee-animate {
    animation: documentcurrencyrupee-animate 0.6s ease-in-out;
  }

  @keyframes documentcurrencyrupee-animate {
    0% {
      transform: scale(1);
    }
    50% {
