...
>
  <svg
    ...
    class="icon-svg"
    class:documentcurrencybangladeshi-animate={shouldAnimate}
  >
    <path
...
<style>
  ...
  .icon-svg.documentcurrencybangladeshi-animate {
    animation: documentcurrencybangladeshi-animate 0.6s ease-in-out;
  }

  @keyframes documentcurrencybangladeshi-animate {
    0% {
      transform: scale(1);
    }
    50% {
