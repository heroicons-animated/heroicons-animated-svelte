...
>
  <svg
    ...
    class="icon-svg"
    class:arrowuponsquarestack-animate={isAnimating}
  >
    <path
    ...
    />
    <path d="M13.5 4.5L10.5 1.5M10.5 1.5L7.5 4.5M10.5 1.5L10.5 12.75" />
    <path
...
<style>
  ...
  .icon-svg.arrowuponsquarestack-animate {
    animation: arrowuponsquarestack-animate 0.6s ease-in-out;
  }

  @keyframes arrowuponsquarestack-animate {
    0% {
      transform: scale(1);
    }
    50% {
